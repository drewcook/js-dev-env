...
2. **Clone this repository.** - `git clone https://github.com/drewcook/js-dev-env.git` or [download the zip](https://github.com/drewcook/js-dev-env/archive/master.zip)
...
6. Seeing `Error: listen EADDRINUSE :::5000`? That means port 5000 is already in use on your machine. You probably have another instance of this project running on your machine in a different window. So find that window and kill the other instance using Ctrl+C.
